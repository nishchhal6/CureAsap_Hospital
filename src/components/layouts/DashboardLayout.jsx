...
import {
  Hospital, User, Bed, Truck, Users, AlertCircle,
  Bell, Edit3, Save, X
} from 'lucide-react'
...
const DashboardLayout = () => {
  ...
  const menuItems = [
    ...
    { id: 'drivers', title: 'Driver Management', icon: Users, path: '/drivers' },
    { id: 'ambulance', title: 'Ambulance Management', icon: Truck, path: '/ambulance' },
    { id: 'patients', title: 'Patient Records', icon: User, path: '/patients' },
    { id: 'emergencies', title: 'Emergency Requests', icon: AlertCircle, path: '/emergencies' }
  ]

  const notifications = [
    { id: 1, title: 'New emergency request', time: '2 min ago', type: 'emergency' },
    { id: 2, title: 'Bed ICU-12 cleaned', time: '15 min ago', type: 'bed' },
    { id: 3, title: 'Driver Ravi Kumar arrived', time: '1 hr ago', type: 'driver' }
  ]
